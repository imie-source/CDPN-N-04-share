...
public class TPJDBC {
	...
	public static void main(String[] args) {
		...
		IEcoleService ecoleService = EcoleService.getInstance();
		...
		while (!endApp) {
			try {
				...
				if (saisie.compareTo("X") == 0) {
					...
					switch (menu) {
					case 1:
						dtos = ecoleService.findAllPersonne();
					...
					case 2:
						PersonneDTO personneToInsert = typePersonne(scanner,
								simpleDateFormat);
						PersonneDTO personneInserted = ecoleService
								.insertPersonne(personneToInsert);
					...
					case 4:
						...
						PersonneDTO personneUpdated = ecoleService
								.updatePersonne(selectedPersonne);
